...
const FrancoSection = () => (
    <div className="p-6 flex flex-col items-center md:items-start">
        ...
        <a
            href="/docs/CV-Franco-Echeverria.pdf" // Ruta del archivo en el servidor
            download="CV-Franco-Echeverria.pdf" // Nombre con el que se descargará el archivo
            className="mt-6 px-6 py-2 text-[#D946EF]  font-bold rounded-lg transition 
